...
var scripts = {
    ...
    /*
    volumeUp:
        'tell application "Radiant Player" to set sound volume to (sound volume + 10)',
    volumeDown:
        'tell application "Radiant Player" to set sound volume to (sound volume - 10)',
    setVolume:
        'tell application "Radiant Player" to set sound volume to %s',
    play:
        'tell application "Radiant Player" to playpause',
    playTrack:
        'tell application "Radiant Player" to play track "%s"',
    pause:
        'tell application "Radiant Player" to pause',
    jumpTo:
        'tell application "Radiant Player" to set player position to %s',
    */
    playPause:
        'tell application "Radiant Player" to playpause',
    next:
        'tell application "Radiant Player" to next track',
    previous:
        'tell application "Radiant Player" to back track',
    isRunning:
        'get running of application "Radiant Player"'
};
